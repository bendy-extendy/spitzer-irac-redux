...
###-Meta-Data-###:Date=08/25/2014
###-Meta-Data-###:User-Name=jrrigby1
###-Meta-Data-###:Host-Name=gs66-satchmo.ndc.nasa.gov
...
IMAGE_STACK_FILE_NAME = THE_CLUSTER_DIR/all_bcbcd.list
SIGMALIST_FILE_NAME = THE_CLUSTER_DIR/all_cbunc.list
DCE_STATUS_MASK_LIST = 
PMASK_FILE_NAME = /Volumes/ASD_Snow_Leopard_System/Applications/mopex/cal/super_masks/chan1_ormask_bcd.fits
RMASK_LIST = 
...
ncpu_multiprocess = 1
ARRAY_CORR_IMAGE = /Volumes/ASD_Snow_Leopard_System/Applications/mopex/cal/ch1_photcorr_rj_warm.fits
RMASK_MOSAIC_DIR = RmaskMosaic-mosaic
ARRAY_PIXAREA_IMAGE = /Volumes/ASD_Snow_Leopard_System/Applications/mopex/cal/ch1relpixarea.fits
do_multiprocess = 'on'
