#!/usr/bin/env /Users/jrrigby1/miniforge3/envs/astropy/bin/python -W ignore
# The above line is hacky -- this should point to a python installation that works, and that has the modules below
from re import sub
